...
def loadData(fname):
    ...
    for l in myData:
        ...
        inputSize.append(l[2])
        elapsedTime.append(l[1])
...
plt.grid(True)
plt.savefig("plots/pioverhead.png", format = "png", dpi = 350)
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig("plots/pitime.png", format = "png", dpi = 350)
plt.close()
...
plt.xlabel("input size")
plt.ylabel("speedup")
plt.savefig("plots/pispeedup_size.png", format = "png", dpi = 350)
plt.close()
...
plt.ylabel("speedup")
plt.savefig("plots/pispeedup_cores.png", format = "png", dpi = 350)
plt.close()
...
plt.savefig("plots/piefficiency_cores.png", format = "png", dpi = 350)
plt.close()
...
plt.xlabel("input size")                                                                  
plt.ylabel("efficiency")                                                                     
plt.savefig("plots/piefficiency_size.png", format = "png", dpi = 350)
plt.close()

#plot time vs input size for rand and rand_r
randInputSize, randElapsedTime = loadData("parallel8")
plt .plot(inputSize[8], elapsedTime[8], 'ko-', label = "rand_r()")
plt.plot(randInputSize, randElapsedTime, 'k^--', label = "rand()")
plt.legend()
plt.grid(True)
plt.xscale("log")
plt.yscale("log")
plt.xlabel("input size")
plt.ylabel("time taken on 8 cores")
plt.savefig("plots/rand_rand_r.png", format = "png", dpi = 350)
plt.close()
